import{j as a}from"./index-CTAXdLKx.js";import{r as C}from"./index-D5jfS-9e.js";import{C as R,a as G,u as Cn,S as y,P as Re,D as Ge,b as ge,Q as me,i as yn,c as Me,d as wn,G as vn,e as bn,f as xn,g as Dn,h as O,W as En,A as Z,j as Ce,k as dn,O as An,T as ke,U as Tn,l as Rn}from"./useGridTheme-BCOLcQCg.js";import"./client-Spw3EFno.js";import{m as Gn,a as Mn,e as kn,b as Fn,c as qn}from"./data-VBpboi3O.js";const Vn=[40,80,120,200],ye=r=>{var be,xe,De,Ee,Ae,Te;const{enableRtl:w,enableRipple:u,localDataCount:s,isTextWrapData:m,isDialogInsideGrid:g,isStrictMode:x,isMultipleChildren:M,enableDarkMode:A=!1,builtInThemes:ee="material",parentContainerHeight:un="87vh",isCustomBinding:z,serverPageSize:ne,defaultOpenGroupExpandKeys:N,isConditionalRowSelection:we,...e}=r;((De=(xe=e.columns)==null?void 0:xe[((be=e.columns)==null?void 0:be.length)-1])==null?void 0:De.headerText)==="Command Actions"&&(e.columns[((Ee=e.columns)==null?void 0:Ee.length)-1].getCommandItems=()=>[a.jsx(R,{type:G.Edit},"Edit"),a.jsx(R,{type:G.Delete},"Delete"),a.jsx(R,{type:G.Update},"Update"),a.jsx(R,{type:G.Cancel},"Cancel")]);const f=C.useRef(null),he=C.useRef(null),[fe,cn]=C.useState(!0),[k,pn]=C.useState(!1);Cn(ee,e.enableDevMode);const D=C.useMemo(()=>m?Gn(s):Mn(s,e.columns),[s,(Ae=e.columns)==null?void 0:Ae.length]),[mn,gn]=C.useState({result:[],count:0,hasMore:((Te=r.virtualizationSettings)==null?void 0:Te.scrollMode)===y.Infinite}),Se=C.useCallback(n=>{if(!n.isComplex)return new Re(n.field,n.operator,n.value,n.ignoreCase,n.ignoreAccent,n.matchCase);let t=null;const o=n.predicates||[],c=n.condition||"and";for(let p=0;p<o.length;p++){const d=Se(n.predicates[p]);t===null?t=d:t=c.toLowerCase()==="or"?t.or(d):t.and(d)}return t||new Re("","","")},[]),ve=n=>{var c,p,d,h,E,v,F,L,P,j,W,U,H,B,K,q,Q,V,$,I,_,J,X;const t=new ge(D),o=new me;if((c=n.where)!=null&&c.length){const i=n.where[0],l=Se(i);o.where(l)}if((p=n.search)!=null&&p.length){const{fields:i,value:l}=n.search[0];o.search(l,i)}if((d=n.sort)!=null&&d.length||(h=n.groups)!=null&&h.length&&n.isInitialLoad)if(n.isInitialLoad&&((E=n.groups)!=null&&E.length)){const i=[];for(let l=n.sort.length-1;l>-1;l--)(i==null?void 0:i.find(S=>S.field===n.sort[l].field))||((v=n.groups)!=null&&v.length&&((F=n.groups)!=null&&F.includes(n.sort[l].field))?i.push({field:n.sort[l].field,direction:n.sort[l].direction}):o.sortBy(n.sort[l].field,n.sort[l].direction));i.length&&i.forEach(l=>{o.sortBy(l.field,l.direction)})}else n.sort.forEach(i=>{o.sortBy(i.field,i.direction)});if((L=n.aggregates)!=null&&L.length||(j=(P=f.current)==null?void 0:P.aggregates)!=null&&j.length){const i=(W=n.aggregates)!=null&&W.length?n.aggregates:(U=f.current)==null?void 0:U.aggregates;for(let l=0;l<(i==null?void 0:i.length);l++)if((H=i[l])!=null&&H.columns)for(let b=0;b<((B=i[l])==null?void 0:B.columns.length);b++){const S=i[l].columns[b];if(Array.isArray(S.type))for(let Y=0;Y<S.type.length;Y++)o.aggregate((Q=(q=(K=S.type)==null?void 0:K[Y])==null?void 0:q.toLowerCase)==null?void 0:Q.call(q),S.field);else o.aggregate(($=(V=S.type)==null?void 0:V.toLowerCase)==null?void 0:$.call(V),S.field)}else{const b=i[l];o.aggregate((_=(I=b.type)==null?void 0:I.toLowerCase)==null?void 0:_.call(I),b.field)}}if(n.groups&&((J=n.groups)!=null&&J.length))for(let i=0;i<n.groups.length;i++){const l=n.groups[parseInt(i.toString(),10)];o.group(l)}if(n.take&&n.skip){const i=n.skip/n.take+1,l=n.take;o.page(i,l)}else if(n.skip===0&&n.take)o.page(1,n.take);else if(!yn(n.skip)&&!n.take&&((X=r.virtualizationSettings)==null?void 0:X.scrollMode)===y.Infinite){const i=n.skip/ne+1;o.page(i,ne)}n.requiresCounts&&o.requiresCount(),t.executeQuery(o).then(i=>{if(n.requestType==="filterChoiceRequest"){const l={result:Me.distinct(i.result,n.select[0],!0),count:i.count};if(n.distinctCounts){const b=new me;if(n.distinct){const S=n.distinct[0],Y=Se(S);b.where(Y)}n.select&&b.select(n.select),t.executeQuery(b).then(S=>{l.distinctCount=Me.distinct(S.result,n.select[0],!0).length,n.dataSource(l)})}else n.dataSource(l)}else gn({...i,hasMore:D.length>(n.skip??0)+i.result.length})})},hn=n=>{setTimeout(()=>{if(n.action==="Add"&&D.unshift(n.data),n.action==="Edit"){for(var t=0;t<D.length;t++)if(D[t].id==n.data.id){D[t]=n.data;break}}if(n.action=="Delete"){for(var o=0;o<n.data.length;o++)for(var t=0;t<D.length;t++)if(D[t].id==n.data[o].id){D.splice(t,1);break}}n.saveDataChanges()},0)},fn=C.useMemo(()=>{var c,p;if(!z)return;const n=((c=e==null?void 0:e.aggregates)==null?void 0:c.reduce((d,h)=>{var E;return(E=h.columns)==null||E.forEach(v=>{Array.isArray(v.type)?v.type.forEach(F=>{d.push({type:F.toLowerCase(),field:v.field})}):d.push({type:v.type.toLowerCase(),field:v.field})}),d},[]))??[],t=((p=e==null?void 0:e.columns)==null?void 0:p.reduce((d,h)=>(h.groupCaptionAggregateType&&d.push(...Array.isArray(h.groupCaptionAggregateType)?h.groupCaptionAggregateType.map(E=>({type:E.toLowerCase(),field:h.field})):[{type:h.groupCaptionAggregateType.toLowerCase(),field:h.field}]),d),[]))??[],o=n==null?void 0:n.concat(t);return o!=null&&o.length?o:void 0},[z,e==null?void 0:e.aggregates,e==null?void 0:e.columns,k]);C.useEffect(()=>{var n,t,o,c,p,d,h,E,v,F,L,P,j,W,U,H,B,K,q,Q,V,$;z&&k&&ve({skip:((n=e==null?void 0:e.pageSettings)==null?void 0:n.currentPage)*((t=e==null?void 0:e.pageSettings)==null?void 0:t.pageSize)||0,...((o=e.virtualizationSettings)==null?void 0:o.scrollMode)!==y.Infinite||(c=e.pageSettings)!=null&&c.estimatedTotalRecordsCount||((p=e.pageSettings)==null?void 0:p.pageSizeControlledBy)==="client"?{take:ne??((d=e==null?void 0:e.pageSettings)==null?void 0:d.pageSize)??(((h=e.virtualizationSettings)==null?void 0:h.scrollMode)===y.Auto||!((E=e.virtualizationSettings)!=null&&E.scrollMode)?12:50)}:{take:ne},groups:(v=e==null?void 0:e.groupSettings)!=null&&v.enabled?(F=e==null?void 0:e.groupSettings)==null?void 0:F.columns:[],where:[],search:[],sort:(L=e==null?void 0:e.sortSettings)!=null&&L.enabled&&((j=(P=e==null?void 0:e.sortSettings)==null?void 0:P.columns)!=null&&j.length)&&(!((W=e==null?void 0:e.groupSettings)!=null&&W.enabled)||!((U=e==null?void 0:e.groupSettings)!=null&&U.columns))?(H=e==null?void 0:e.sortSettings)==null?void 0:H.columns:(((B=e==null?void 0:e.sortSettings)==null?void 0:B.columns)??[]).concat((K=e==null?void 0:e.groupSettings)!=null&&K.enabled&&((q=e==null?void 0:e.groupSettings)!=null&&q.columns)?(V=(Q=e==null?void 0:e.groupSettings)==null?void 0:Q.columns)==null?void 0:V.map(I=>{var _,J,X;return{field:I,direction:((X=(J=(_=e==null?void 0:e.sortSettings)==null?void 0:_.columns)==null?void 0:J.find(i=>i.field===I))==null?void 0:X.direction)??"Ascending"}}):[]),aggregates:fn??[],...(($=e.virtualizationSettings)==null?void 0:$.scrollMode)!==y.Infinite?{requiresCounts:!0}:{},isInitialLoad:!0})},[k]),C.useEffect(()=>{A?document.body.classList.add("dark","sf-dark-mode"):document.body.classList.remove("dark","sf-dark-mode")},[A]);const Sn=C.useCallback(n=>n.id%2===0||n.EmployeeID%2===0||n.RecordId%2===0?{selectable:!1}:!0,[we]),te=()=>{var n;return a.jsxs(a.Fragment,{children:[a.jsxs("button",{onClick:()=>{var t,o;k&&window.localStorage.removeItem((o=(t=f==null?void 0:f.current)==null?void 0:t.getDataModule())==null?void 0:o.dataManager.guidId),pn(!k)},children:[k?"Destroy":"Render"," Data Grid"]}),s&&!m&&a.jsxs("button",{onClick:()=>cn(!fe),children:[fe?"Uniform":"Non Uniform"," Row Height Applied"]}),(n=e==null?void 0:e.groupSettings)!=null&&n.enabled?a.jsxs(a.Fragment,{children:[a.jsx("button",{onClick:()=>{var t,o,c;(c=(t=f.current)==null?void 0:t.groupColumn)==null||c.call(t,(o=e==null?void 0:e.groupSettings)==null?void 0:o.columns,!0)},children:"Reset Grouped Columns to Default"}),a.jsx("button",{onClick:()=>{var t,o,c,p,d;(d=(t=f.current)==null?void 0:t.ungroupColumn)==null||d.call(t,[(p=(c=(o=f.current)==null?void 0:o.groupSettings)==null?void 0:c.columns)==null?void 0:p[0]])},children:"Un Group First Grouped Column"}),a.jsx("button",{onClick:()=>{var t,o;(o=(t=f.current)==null?void 0:t.expandAll)==null||o.call(t)},children:"Expand All"}),a.jsx("button",{onClick:()=>{var t,o;(o=(t=f.current)==null?void 0:t.collapseAll)==null||o.call(t)},children:"Collapse All"}),a.jsx("button",{onClick:()=>{var t,o;(o=(t=f.current)==null?void 0:t.clearGrouping)==null||o.call(t)},children:"Clear Grouping"})]}):null,a.jsx("br",{}),a.jsx("br",{}),k&&a.jsx(wn,{dir:w?"rtl":"ltr",ripple:u,locale:e.locale,children:a.jsx(vn,{ref:f,dataSource:z?mn:s?D:[],onDataRequest:z?ve:void 0,onDataChangeRequest:z?hn:void 0,shouldExpandGroup:N!=null&&N.length?t=>{var o;return(o=N.includes)==null?void 0:o.call(N,t==null?void 0:t.groupKey)}:void 0,onError:t=>{console.error("Grid Error: ",t)},...e,isRowSelectable:we?Sn:void 0,columns:e.children?void 0:e.columns,aggregates:e.children?void 0:e.aggregates,getRowHeight:fe?null:t=>Vn[t.rowIndex%4],children:M?e.children.props.children:e.children})}),a.jsx("br",{}),a.jsx("button",{onClick:()=>{console.log(f)},children:"dummy navigation checking button with get GridRef"})]})};return a.jsx("div",{ref:he,style:{height:un,isolation:"isolate"},className:A?"dark sf-dark-mode":"",children:x?a.jsx(C.StrictMode,{children:g?a.jsx(Ge,{open:!0,fullScreen:!0,target:he.current,children:te()}):te()}):g?a.jsx(Ge,{open:!0,fullScreen:!0,target:he.current,children:te()}):te()})};try{ye.displayName="LargeDataGridTest",ye.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
}`,...(Ke=(Be=le.parameters)==null?void 0:Be.docs)==null?void 0:Ke.source}}};var Qe,$e,_e;se.parameters={...se.parameters,docs:{...(Qe=se.parameters)==null?void 0:Qe.docs,source:{originalSource:`{
  args: {
    localDataCount: 100000,
    isTextWrapData: true,
    columns: muicolumns,
...
}`,...(_e=($e=se.parameters)==null?void 0:$e.docs)==null?void 0:_e.source}}};var Je,Xe,Ye;de.parameters={...de.parameters,docs:{...(Je=de.parameters)==null?void 0:Je.docs,source:{originalSource:`{
  args: {
    localDataCount: 1000,
    columns: (() => {
