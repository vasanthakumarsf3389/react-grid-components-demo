import{j as e}from"./index-C6j-OS9u.js";import{r as i}from"./index-CtNveh2g.js";import{C as r,a as o,m as $,D as E,P as Y,G as Z,b as ee,c as ne,S as L,Q as te,d as U,e as ae,f as H,g as t,U as re,W as oe,T,h as ie}from"./data-BkwSu5dJ.js";import"./index-LwkqeIug.js";const le=[40,80,120,200],y=a=>{var C,b,x,D,R;const{enableRtl:h,enableRipple:W,localDataCount:l,isDialogInsideGrid:v,isStrictMode:O,isMultipleChildren:B,parentContainerHeight:_="93vh",...n}=a;((x=(b=n.columns)==null?void 0:b[((C=n.columns)==null?void 0:C.length)-1])==null?void 0:x.headerText)==="Command Actions"&&(n.columns[((D=n.columns)==null?void 0:D.length)-1].getCommandItems=()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]);const S=i.useRef(null),g=i.useRef(null),[f,Q]=i.useState(!0),[w,J]=i.useState(!1),K=i.useMemo(()=>$(l,n.columns),[l,(R=n.columns)==null?void 0:R.length]),s=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>J(!w),children:[w?"Destroy":"Render"," Data Grid"]}),l&&e.jsxs("button",{onClick:()=>Q(!f),children:[f?"Uniform":"Non Uniform"," Row Height Applied"]}),w&&e.jsx(Y,{dir:h?"rtl":"ltr",ripple:W,locale:n.locale,children:e.jsx(Z,{ref:S,dataSource:l?K:[],...n,columns:n.children?void 0:n.columns,aggregates:n.children?void 0:n.aggregates,getRowHeight:f?null:X=>le[X.rowIndex%4],children:B?n.children.props.children:n.children})}),e.jsx("button",{onClick:()=>{console.log(S)},children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:g,style:{height:_},children:O?e.jsx(i.StrictMode,{children:v?e.jsx(E,{open:!0,fullScreen:!0,target:g.current,children:s()}):s()}):v?e.jsx(E,{open:!0,fullScreen:!0,target:g.current,children:s()}):s()})};try{y.displayName="LargeDataGridTest",y.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
\`\`\``,name:"onDataChangeCancel",required:!1,type:{name:"(event: FormCancelEvent<unknown>) => void"}}}}}catch{}const me={title:"Grid/VirtualGridBase",component:y,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","100","1000","10000","100000"],description:"Grid Local DataSource Count"}}},m=ne(100,!1),se=[{columns:ee(m.length)}];m.unshift({type:ie.Checkbox,width:50,allowFilter:!1});m.push({headerText:"Command Actions",width:200,getCommandItems:()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]});const d={args:{localDataCount:1e5,columns:m,aggregates:se,editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%"}},u={args:{dataSource:new U({url:"https://ej2services.syncfusion.com/react/hotfix/api/UrlDataSource",adaptor:new re}),query:new te().addParams("dataCount","100000"),toolbar:["Search"],children:e.jsxs(H,{children:[e.jsx(t,{field:"EmployeeID",visible:!1,headerText:"Employee ID",isPrimaryKey:!0,width:"130"}),e.jsx(t,{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"}),e.jsx(t,{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"}),e.jsx(t,{field:"Mail",headerText:"Mail",width:"230"}),e.jsx(t,{field:"Location",headerText:"Location",width:"140"}),e.jsx(t,{field:"Status",headerText:"Status",width:"130"}),e.jsx(t,{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"}),e.jsx(t,{field:"Rating",headerText:"Rating",width:"220"}),e.jsx(t,{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"}),e.jsx(t,{field:"CurrentSalary",headerText:"Current Salary",width:"160",format:"C2"}),e.jsx(t,{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"})]}),selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{enableCache:!1,scrollMode:L.Virtual},height:"100%"}},c={args:{dataSource:new U({url:"https://ej2services.syncfusion.com/react/hotfix/api/GridWebAPIService",adaptor:new oe}),columns:[{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130",allowSearch:!1},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1}],selectionSettings:{mode:"Single"},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{scrollMode:L.Virtual},height:"100%"}},p={args:{dataSource:ae,children:e.jsxs(H,{children:[e.jsx(t,{headerText:"Employee Image",width:"180",textAlign:T.Center,field:"EmployeeID"}),e.jsx(t,{headerText:"Employee Details",width:"300",textAlign:T.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:a=>{const h=`https://npmci-react.syncfusion.com/development-react-ui/images/grid/${a.EmployeeID}.png`;return e.jsxs("tr",{className:"templateRow",children:[e.jsx("td",{className:"photo",children:e.jsx("img",{src:h,alt:a.EmployeeID.toString()})}),e.jsx("td",{className:"details",children:e.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"30%"}}),e.jsx("col",{style:{width:"10%"}})]}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"First Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.FirstName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Last Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.LastName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Title"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.Title})]})]})]})})]})}}};var G,A,q;d.parameters={...d.parameters,docs:{...(G=d.parameters)==null?void 0:G.docs,source:{originalSource:`{
  args: {
...
}`,...(q=(A=d.parameters)==null?void 0:A.docs)==null?void 0:q.source}}};var F,k,V;u.parameters={...u.parameters,docs:{...(F=u.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
...
}`,...(V=(k=u.parameters)==null?void 0:k.docs)==null?void 0:V.source}}};var j,I,M;c.parameters={...c.parameters,docs:{...(j=c.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(M=(I=c.parameters)==null?void 0:I.docs)==null?void 0:M.source}}};var P,z,N;p.parameters={...p.parameters,docs:{...(P=p.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(N=(z=p.parameters)==null?void 0:z.docs)==null?void 0:N.source}}};const he=["LocalData","UrlAdaptorData","WebApiAdaptorData","RowTemplate"];export{d as LocalData,p as RowTemplate,u as UrlAdaptorData,c as WebApiAdaptorData,he as __namedExportsOrder,me as default};
