import{j as e}from"./index-C6j-OS9u.js";import{r as i}from"./index-CtNveh2g.js";import{C as r,a as o,m as ee,D as G,P as ne,G as te,b as ae,c as re,S as B,Q as oe,d as _,e as ie,f as C,g as t,U as le,W as se,T as A,h as de}from"./data-BORkfj6q.js";import"./index-LwkqeIug.js";const ue=[40,80,120,200],S=a=>{var x,D,R,E,T;const{enableRtl:l,enableRipple:K,localDataCount:f,isDialogInsideGrid:b,isStrictMode:Q,isMultipleChildren:J,parentContainerHeight:X="93vh",...n}=a;((R=(D=n.columns)==null?void 0:D[((x=n.columns)==null?void 0:x.length)-1])==null?void 0:R.headerText)==="Command Actions"&&(n.columns[((E=n.columns)==null?void 0:E.length)-1].getCommandItems=()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]);const s=i.useRef(null),w=i.useRef(null),[$,he]=i.useState(!0),[y,Y]=i.useState(!1),Z=i.useMemo(()=>ee(f,n.columns),[f,(T=n.columns)==null?void 0:T.length]),d=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>Y(!y),children:[y?"Destroy":"Render"," Data Grid"]}),y&&e.jsx(ne,{dir:l?"rtl":"ltr",ripple:K,locale:n.locale,children:e.jsx(te,{ref:s,dataSource:f?Z:[],...n,columns:n.children?void 0:n.columns,aggregates:n.children?void 0:n.aggregates,onRowSelect:v=>{console.log(v.data)},getRowHeight:$?null:v=>ue[v.rowIndex%4],children:J?n.children.props.children:n.children})}),e.jsx("button",{onClick:()=>s.current.selectRows([1,2,3]),children:"selectRows"}),e.jsx("button",{onClick:()=>{console.log(s.current.getSelectedRowIndexes(),s.current.getSelectedRecords())},children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:w,style:{height:X},children:Q?e.jsx(i.StrictMode,{children:b?e.jsx(G,{open:!0,fullScreen:!0,target:w.current,children:d()}):d()}):b?e.jsx(G,{open:!0,fullScreen:!0,target:w.current,children:d()}):d()})};try{S.displayName="LargeDataGridTest",S.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
\`\`\``,name:"onDataChangeCancel",required:!1,type:{name:"(event: FormCancelEvent<unknown>) => void"}}}}}catch{}const ve={title:"Grid/VirtualGridBase",component:S,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","100","1000","10000","100000"],description:"Grid Local DataSource Count"}}},g=re(100,!1),ce=[{columns:ae(g.length)}];g.unshift({type:de.Checkbox,width:50,allowFilter:!1});g.push({headerText:"Command Actions",width:200,getCommandItems:()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]});const u={args:{localDataCount:1e5,columns:g,aggregates:ce,editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%"}},c={args:{dataSource:new _({url:"https://ej2services.syncfusion.com/react/hotfix/api/UrlDataSource",adaptor:new le}),query:new oe().addParams("dataCount","100000"),toolbar:["Search"],children:e.jsxs(C,{children:[e.jsx(t,{field:"EmployeeID",visible:!1,headerText:"Employee ID",isPrimaryKey:!0,width:"130"}),e.jsx(t,{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"}),e.jsx(t,{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"}),e.jsx(t,{field:"Mail",headerText:"Mail",width:"230"}),e.jsx(t,{field:"Location",headerText:"Location",width:"140"}),e.jsx(t,{field:"Status",headerText:"Status",width:"130"}),e.jsx(t,{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"}),e.jsx(t,{field:"Rating",headerText:"Rating",width:"220"}),e.jsx(t,{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"}),e.jsx(t,{field:"CurrentSalary",headerText:"Current Salary",width:"160",format:"C2"}),e.jsx(t,{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"})]}),selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{enableCache:!1,scrollMode:B.Virtual},height:"100%"}},p={args:{dataSource:new _({url:"https://ej2services.syncfusion.com/react/hotfix/api/GridWebAPIService",adaptor:new se}),columns:[{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130",allowSearch:!1},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1}],selectionSettings:{mode:"Single"},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{scrollMode:B.Virtual},height:"100%"}},m={args:{dataSource:ie,children:e.jsxs(C,{children:[e.jsx(t,{headerText:"Employee Image",width:"180",textAlign:A.Center,field:"EmployeeID"}),e.jsx(t,{headerText:"Employee Details",width:"300",textAlign:A.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:a=>{const l=`https://npmci-react.syncfusion.com/development-react-ui/images/grid/${a.EmployeeID}.png`;return e.jsxs("tr",{className:"templateRow",children:[e.jsx("td",{className:"photo",children:e.jsx("img",{src:l,alt:a.EmployeeID.toString()})}),e.jsx("td",{className:"details",children:e.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"30%"}}),e.jsx("col",{style:{width:"10%"}})]}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"First Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.FirstName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Last Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.LastName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Title"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.Title})]})]})]})})]})}}},pe=[{OrderID:1,CustomerID:"VINET",Freight:32.38},{OrderID:2,CustomerID:"TOMSP",Freight:11.61},{OrderID:3,CustomerID:"HANAR",Freight:65.83},{OrderID:4,CustomerID:"VICTE",Freight:41.34},{OrderID:5,CustomerID:"SUPRD",Freight:51.3}],me=[{field:"OrderID",headerText:"Order ID",width:"120",isPrimaryKey:!0},{field:"CustomerID",headerText:"Customer ID",width:"120",validationRules:{required:!0,minLength:3}},{field:"Freight",headerText:"Freight",width:"120",validationRules:{required:!0,min:0}}],h={args:{dataSource:pe,editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},selectionSettings:{mode:"Multiple"},height:400,children:e.jsx(C,{children:me.map((a,l)=>e.jsx(t,{...a},l))})}};var q,F,k;u.parameters={...u.parameters,docs:{...(q=u.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
...
}`,...(k=(F=u.parameters)==null?void 0:F.docs)==null?void 0:k.source}}};var V,I,j;c.parameters={...c.parameters,docs:{...(V=c.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
...
}`,...(j=(I=c.parameters)==null?void 0:I.docs)==null?void 0:j.source}}};var M,P,z;p.parameters={...p.parameters,docs:{...(M=p.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(z=(P=p.parameters)==null?void 0:P.docs)==null?void 0:z.source}}};var N,L,U;m.parameters={...m.parameters,docs:{...(N=m.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(U=(L=m.parameters)==null?void 0:L.docs)==null?void 0:U.source}}};var H,W,O;h.parameters={...h.parameters,docs:{...(H=h.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    ...
    height: 400,
    children: <Columns>\r
                    {editableColumns.map((col, index) => <Column key={index} {...col} />)}\r
                </Columns>
  }
}`,...(O=(W=h.parameters)==null?void 0:W.docs)==null?void 0:O.source}}};const Se=["LocalData","UrlAdaptorData","WebApiAdaptorData","RowTemplate","TestSample"];export{u as LocalData,m as RowTemplate,h as TestSample,c as UrlAdaptorData,p as WebApiAdaptorData,Se as __namedExportsOrder,ve as default};
