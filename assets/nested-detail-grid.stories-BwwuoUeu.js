...
`}}}};var D,y,f,w,b;o.parameters={...o.parameters,docs:{...(D=o.parameters)==null?void 0:D.docs,source:{originalSource:`(): JSX.Element => {
...
}`,...(f=(y=o.parameters)==null?void 0:y.docs)==null?void 0:f.source},description:{story:`Story 1: Master Detail with Traditional detailRowTemplate\r
Demonstrates backward-compatible detail row rendering`,...(b=(w=o.parameters)==null?void 0:w.docs)==null?void 0:b.description}}};var O,I,j,L,v;h.parameters={...h.parameters,docs:{...(O=h.parameters)==null?void 0:O.docs,source:{originalSource:`(): JSX.Element => {
  useGridTheme('material');
...
}`,...(j=(I=h.parameters)==null?void 0:I.docs)==null?void 0:j.source},description:{story:`Story 2: Nested Detail Grid with Callbacks\r
Demonstrates callback-based data loading with lifecycle hooks`,...(v=(L=h.parameters)==null?void 0:L.docs)==null?void 0:v.description}}};var T,C,A,P,k;p.parameters={...p.parameters,docs:{...(T=p.parameters)==null?void 0:T.docs,source:{originalSource:`(): JSX.Element => {
  useGridTheme('material');
  const handleDetailRowTemplate = (data: OrderItem) => {
    const lineItems = detailDataMap[data.OrderID] || [];
    return <div style={{
...
Demonstrates recursive nesting with depth enforcement`,...(k=(P=p.parameters)==null?void 0:P.docs)==null?void 0:k.description}}};const Q=["MasterDetailWithTemplate","NestedDetailGridWithCallbacks","MultiLevelNestedGrids"];export{o as MasterDetailWithTemplate,p as MultiLevelNestedGrids,h as NestedDetailGridWithCallbacks,Q as __namedExportsOrder,M as default};
