import{j as e}from"./index-B6UdnZfq.js";import{r as a}from"./index-2yJIXLcc.js";import{m as G,P as q,G as A,a as F,b as k,S,Q as V,D as C,C as I,c as n,U as M,W as P}from"./data-DjE7zTM0.js";import"./index-Bn05qqr6.js";const z=[40,80,120,200],s=t=>{var u;const x=a.useRef(null),[l,D]=a.useState(!0),[d,R]=a.useState(!1),E=a.useMemo(()=>G(t.localDataCount,t.columns),[t.localDataCount,(u=t.columns)==null?void 0:u.length]);return e.jsxs("div",{style:{height:"93vh"},children:[e.jsxs("button",{onClick:()=>R(!d),children:[d?"Destroy":"Render"," Data Grid"]}),t.localDataCount&&e.jsxs("button",{onClick:()=>D(!l),children:[l?"Uniform":"Non Uniform"," Row Height Applied"]}),d&&e.jsx(q,{dir:t.enableRtl?"rtl":"ltr",children:e.jsx(A,{ref:x,dataSource:t.localDataCount?E:[],...t,getRowHeight:l?null:T=>(console.log("getRowHeight"),z[T.rowIndex%4]),children:t.children})}),e.jsx("button",{children:"dummy navigation checking button"})]})};try{s.displayName="LargeDataGridTest",s.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{localDataCount:{defaultValue:null,description:"",name:"localDataCount",required:!1,type:{name:"number"}},id:{defaultValue:{value:"React.useId()"},description:`Specifies a unique identifier for the grid component.
...
\`\`\``,name:"onDataChangeCancel",required:!1,type:{name:"(event: FormCancelEvent<unknown>) => void"}}}}}catch{}const N={title:"Grid/VirtualGridBase",component:s,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","1000","10000","100000"],description:"Grid Local DataSource Count"},columns:{control:"object"}}},b=k(100),j=[{columns:F(b.length)}],o={args:{localDataCount:1e5,columns:b,aggregates:j,editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},filterSettings:{enabled:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%"}},r={args:{dataSource:new C({url:"https://ej2services.syncfusion.com/react/hotfix/api/UrlDataSource",adaptor:new M}),query:new V().addParams("dataCount","100000"),toolbar:["Search"],children:e.jsxs(I,{children:[e.jsx(n,{field:"EmployeeID",visible:!1,headerText:"Employee ID",isPrimaryKey:!0,width:"130"}),e.jsx(n,{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"}),e.jsx(n,{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"}),e.jsx(n,{field:"Mail",headerText:"Mail",width:"230"}),e.jsx(n,{field:"Location",headerText:"Location",width:"140"}),e.jsx(n,{field:"Status",headerText:"Status",width:"130"}),e.jsx(n,{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"}),e.jsx(n,{field:"Rating",headerText:"Rating",width:"220"}),e.jsx(n,{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"}),e.jsx(n,{field:"CurrentSalary",headerText:"Current Salary",width:"160",format:"C2"}),e.jsx(n,{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"})]}),selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{enableCache:!1},scrollMode:S.Virtual,height:"100%"}},i={args:{dataSource:new C({url:"https://ej2services.syncfusion.com/react/hotfix/api/GridWebAPIService",adaptor:new P}),columns:[{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130"},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip"},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowFilter:!1,allowSort:!1}],toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},scrollMode:S.Virtual,height:"100%"}};var c,p,m;o.parameters={...o.parameters,docs:{...(c=o.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
...
}`,...(m=(p=o.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};var h,g,f;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
...
}`,...(f=(g=r.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};var w,v,y;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(y=(v=i.parameters)==null?void 0:v.docs)==null?void 0:y.source}}};const O=["LocalData","UrlAdaptorData","WebApiAdaptorData"];export{o as LocalData,r as UrlAdaptorData,i as WebApiAdaptorData,O as __namedExportsOrder,N as default};
