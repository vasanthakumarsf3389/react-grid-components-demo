import{j as e}from"./index-C6j-OS9u.js";import{r as i}from"./index-CtNveh2g.js";import{C as r,a as o,m as ee,D as T,P as ne,G as te,b as ae,c as re,S as O,Q as oe,d as B,e as ie,f as v,g as n,U as le,W as se,T as G,h as de}from"./data-DIa2pN4s.js";import"./index-LwkqeIug.js";const ue=[40,80,120,200],y=a=>{var b,x,D,R,E;const{enableRtl:h,enableRipple:_,localDataCount:g,isDialogInsideGrid:S,isStrictMode:K,isMultipleChildren:Q,parentContainerHeight:J="93vh",...t}=a;((D=(x=t.columns)==null?void 0:x[((b=t.columns)==null?void 0:b.length)-1])==null?void 0:D.headerText)==="Command Actions"&&(t.columns[((R=t.columns)==null?void 0:R.length)-1].getCommandItems=()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]);const C=i.useRef(null),f=i.useRef(null),[X,pe]=i.useState(!0),[w,$]=i.useState(!1),Y=i.useMemo(()=>ee(g,t.columns),[g,(E=t.columns)==null?void 0:E.length]),l=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>$(!w),children:[w?"Destroy":"Render"," Data Grid"]}),w&&e.jsx(ne,{dir:h?"rtl":"ltr",ripple:_,locale:t.locale,children:e.jsx(te,{ref:C,dataSource:g?Y:[],...t,columns:t.children?void 0:t.columns,aggregates:t.children?void 0:t.aggregates,getRowHeight:X?null:Z=>ue[Z.rowIndex%4],children:Q?t.children.props.children:t.children})}),e.jsx("button",{onClick:()=>{console.log(C.current.getSelectedRowIndexes())},children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:f,style:{height:J},children:K?e.jsx(i.StrictMode,{children:S?e.jsx(T,{open:!0,fullScreen:!0,target:f.current,children:l()}):l()}):S?e.jsx(T,{open:!0,fullScreen:!0,target:f.current,children:l()}):l()})};try{y.displayName="LargeDataGridTest",y.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
\`\`\``,name:"onDataChangeCancel",required:!1,type:{name:"(event: FormCancelEvent<unknown>) => void"}}}}}catch{}const we={title:"Grid/VirtualGridBase",component:y,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","100","1000","10000","100000"],description:"Grid Local DataSource Count"}}},m=re(100,!1),ce=[{columns:ae(m.length)}];m.unshift({type:de.Checkbox,width:50,allowFilter:!1});m.push({headerText:"Command Actions",width:200,getCommandItems:()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]});const s={args:{localDataCount:1e5,columns:m,aggregates:ce,editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%"}},d={args:{dataSource:new B({url:"https://ej2services.syncfusion.com/react/hotfix/api/UrlDataSource",adaptor:new le}),query:new oe().addParams("dataCount","100000"),toolbar:["Search"],children:e.jsxs(v,{children:[e.jsx(n,{field:"EmployeeID",visible:!1,headerText:"Employee ID",isPrimaryKey:!0,width:"130"}),e.jsx(n,{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"}),e.jsx(n,{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"}),e.jsx(n,{field:"Mail",headerText:"Mail",width:"230"}),e.jsx(n,{field:"Location",headerText:"Location",width:"140"}),e.jsx(n,{field:"Status",headerText:"Status",width:"130"}),e.jsx(n,{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"}),e.jsx(n,{field:"Rating",headerText:"Rating",width:"220"}),e.jsx(n,{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"}),e.jsx(n,{field:"CurrentSalary",headerText:"Current Salary",width:"160",format:"C2"}),e.jsx(n,{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"})]}),selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{enableCache:!1,scrollMode:O.Virtual},height:"100%"}},u={args:{dataSource:new B({url:"https://ej2services.syncfusion.com/react/hotfix/api/GridWebAPIService",adaptor:new se}),columns:[{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130",allowSearch:!1},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1}],selectionSettings:{mode:"Single"},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{scrollMode:O.Virtual},height:"100%"}},c={args:{dataSource:ie,children:e.jsxs(v,{children:[e.jsx(n,{headerText:"Employee Image",width:"180",textAlign:G.Center,field:"EmployeeID"}),e.jsx(n,{headerText:"Employee Details",width:"300",textAlign:G.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:a=>{const h=`https://npmci-react.syncfusion.com/development-react-ui/images/grid/${a.EmployeeID}.png`;return e.jsxs("tr",{className:"templateRow",children:[e.jsx("td",{className:"photo",children:e.jsx("img",{src:h,alt:a.EmployeeID.toString()})}),e.jsx("td",{className:"details",children:e.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"30%"}}),e.jsx("col",{style:{width:"10%"}})]}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"First Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.FirstName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Last Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.LastName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Title"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.Title})]})]})]})})]})}}},p={args:{dataSource:[{OrderID:1,CustomerID:"A"},{OrderID:2,CustomerID:"B"},{OrderID:3,CustomerID:"C"},{OrderID:4,CustomerID:"D"}],height:400,selectionSettings:{mode:"Multiple"},children:e.jsxs(v,{children:[e.jsx(n,{type:"checkbox",width:"50"}),e.jsx(n,{field:"OrderID",headerText:"Order ID",isPrimaryKey:!0,width:"120"}),e.jsx(n,{field:"CustomerID",headerText:"Customer",width:"120"})]})}};var A,q,F;s.parameters={...s.parameters,docs:{...(A=s.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
...
}`,...(F=(q=s.parameters)==null?void 0:q.docs)==null?void 0:F.source}}};var I,k,V;d.parameters={...d.parameters,docs:{...(I=d.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
...
}`,...(V=(k=d.parameters)==null?void 0:k.docs)==null?void 0:V.source}}};var j,M,P;u.parameters={...u.parameters,docs:{...(j=u.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(P=(M=u.parameters)==null?void 0:M.docs)==null?void 0:P.source}}};var z,N,L;c.parameters={...c.parameters,docs:{...(z=c.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(L=(N=c.parameters)==null?void 0:N.docs)==null?void 0:L.source}}};var U,W,H;p.parameters={...p.parameters,docs:{...(U=p.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    dataSource: [{
      OrderID: 1,
      CustomerID: 'A'
    ...
    children: <Columns>\r
          ...
          <Column field="CustomerID" headerText="Customer" width="120" />\r
        </Columns>
  }
}`,...(H=(W=p.parameters)==null?void 0:W.docs)==null?void 0:H.source}}};const ye=["LocalData","UrlAdaptorData","WebApiAdaptorData","RowTemplate","TestSample"];export{s as LocalData,c as RowTemplate,p as TestSample,d as UrlAdaptorData,u as WebApiAdaptorData,ye as __namedExportsOrder,we as default};
