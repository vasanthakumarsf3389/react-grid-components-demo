import{j as e}from"./index-CTAXdLKx.js";import{r as c}from"./index-D5jfS-9e.js";import{C as p,a as m,m as Ze,b as en,S as d,D as me,c as W,P as he,Q,d as nn,G as tn,e as an,W as on,f as _,A as He,g as rn,O as ln,h as sn,i as ge,T as fe,U as dn,j as un,k as cn}from"./data-hLfRBbnL.js";import"./client-Spw3EFno.js";const pn=[40,80,120,200],K=a=>{var Y,Z,ee,ne,te,ae;const{enableRtl:u,enableRipple:Le,localDataCount:v,isTextWrapData:$,isDialogInsideGrid:J,isStrictMode:Ke,isMultipleChildren:Qe,parentContainerHeight:_e="93vh",isCustomBinding:U,serverPageSize:T,defaultOpenGroupExpandKeys:f,...t}=a;((ee=(Z=t.columns)==null?void 0:Z[((Y=t.columns)==null?void 0:Y.length)-1])==null?void 0:ee.headerText)==="Command Actions"&&(t.columns[((ne=t.columns)==null?void 0:ne.length)-1].getCommandItems=()=>[e.jsx(p,{type:m.Edit},"Edit"),e.jsx(p,{type:m.Delete},"Delete"),e.jsx(p,{type:m.Update},"Update"),e.jsx(p,{type:m.Cancel},"Cancel")]);const h=c.useRef(null),B=c.useRef(null),[N,$e]=c.useState(!0),[S,Je]=c.useState(!1),H=c.useMemo(()=>$?Ze(v):en(v,t.columns),[v,(te=t.columns)==null?void 0:te.length]),[Xe,Ye]=c.useState({result:[],count:0,hasMore:((ae=a.virtualizationSettings)==null?void 0:ae.scrollMode)===d.Infinite}),X=n=>{var C,w,b,x,D,E,oe,re,le,ie,se,A,de,G,ue,q,ce,pe;const s=new W(H),i=new Q;if((C=n.where)!=null&&C.length){let o;const r=n.where[0].predicates;for(let l=0;l<r.length;l++)o?o=o.and(new he(r[l].field,r[l].operator,r[l].value,r[l].ignoreCase,r[l].ignoreAccent,r[l].matchCase)):o=new he(r[l].field,r[l].operator,r[l].value,r[l].ignoreCase,r[l].ignoreAccent,r[l].matchCase);i.where(o)}if((w=n.search)!=null&&w.length){const{fields:o,value:r}=n.search[0];i.search(r,o)}if((b=n.sort)!=null&&b.length&&n.sort.forEach(o=>{i.sortBy(o.field,o.direction)}),(x=n.aggregates)!=null&&x.length||(E=(D=h.current)==null?void 0:D.aggregates)!=null&&E.length){const o=(oe=n.aggregates)!=null&&oe.length?n.aggregates:(re=h.current)==null?void 0:re.aggregates;for(let r=0;r<(o==null?void 0:o.length);r++)if((le=o[r])!=null&&le.columns)for(let l=0;l<((ie=o[r])==null?void 0:ie.columns.length);l++){const y=o[r].columns[l];if(Array.isArray(y.type))for(let L=0;L<y.type.length;L++)i.aggregate((de=(A=(se=y.type)==null?void 0:se[L])==null?void 0:A.toLowerCase)==null?void 0:de.call(A),y.field);else i.aggregate((ue=(G=y.type)==null?void 0:G.toLowerCase)==null?void 0:ue.call(G),y.field)}else{const l=o[r];i.aggregate((ce=(q=l.type)==null?void 0:q.toLowerCase)==null?void 0:ce.call(q),l.field)}}if(n.take&&n.skip){const o=n.skip/n.take+1,r=n.take;i.page(o,r)}else if(n.skip===0&&n.take)i.page(1,n.take);else if(n.skip&&((pe=a.virtualizationSettings)==null?void 0:pe.scrollMode)===d.Infinite){const o=n.skip/T+1;i.page(o,T)}n.requiresCounts&&i.requiresCount(),console.log("CustomBinding Callback Params: ",n),console.log("CustomBinding Query: ",i),s.executeQuery(i).then(o=>{Ye({...o,hasMore:H.length>(n.skip??0)+o.result.length})})};c.useEffect(()=>{var n,s,i,C,w,b,x,D,E;U&&S&&X({skip:((n=t==null?void 0:t.pageSettings)==null?void 0:n.currentPage)*((s=t==null?void 0:t.pageSettings)==null?void 0:s.pageSize)||0,...((i=t.virtualizationSettings)==null?void 0:i.scrollMode)!==d.Infinite||(C=t.pageSettings)!=null&&C.estimatedTotalRecordsCount||((w=t.pageSettings)==null?void 0:w.pageSizeControlledBy)==="client"?{take:T??((b=t==null?void 0:t.pageSettings)==null?void 0:b.pageSize)??(((x=t.virtualizationSettings)==null?void 0:x.scrollMode)===d.Auto||!((D=t.virtualizationSettings)!=null&&D.scrollMode)?12:50)}:{take:T},where:[],search:[],sort:[],aggregates:[],...((E=t.virtualizationSettings)==null?void 0:E.scrollMode)!==d.Infinite?{requiresCounts:!0}:{}})},[S]);const R=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>{var n,s;S&&window.localStorage.removeItem((s=(n=h==null?void 0:h.current)==null?void 0:n.getDataModule())==null?void 0:s.dataManager.guidId),Je(!S)},children:[S?"Destroy":"Render"," Data Grid"]}),v&&!$&&e.jsxs("button",{onClick:()=>$e(!N),children:[N?"Uniform":"Non Uniform"," Row Height Applied"]}),S&&e.jsx(nn,{dir:u?"rtl":"ltr",ripple:Le,locale:t.locale,children:e.jsx(tn,{ref:h,dataSource:U?Xe:v?H:[],onDataRequest:U?X:void 0,shouldExpandGroup:f!=null&&f.length?n=>{var s;return(s=f.includes)==null?void 0:s.call(f,n==null?void 0:n.groupKey)}:void 0,...t,columns:t.children?void 0:t.columns,aggregates:t.children?void 0:t.aggregates,getRowHeight:N?null:n=>pn[n.rowIndex%4],children:Qe?t.children.props.children:t.children})}),e.jsx("button",{onClick:()=>{console.log(h)},children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:B,style:{height:_e,isolation:"isolate"},children:Ke?e.jsx(c.StrictMode,{children:J?e.jsx(me,{open:!0,fullScreen:!0,target:B.current,children:R()}):R()}):J?e.jsx(me,{open:!0,fullScreen:!0,target:B.current,children:R()}):R()})};try{K.displayName="LargeDataGridTest",K.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
}`,...(ve=(ye=M.parameters)==null?void 0:ye.docs)==null?void 0:ve.source}}};var Ce,we,be;k.parameters={...k.parameters,docs:{...(Ce=k.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  args: {
...
}`,...(be=(we=k.parameters)==null?void 0:we.docs)==null?void 0:be.source}}};var xe,De,Ee;F.parameters={...F.parameters,docs:{...(xe=F.parameters)==null?void 0:xe.docs,source:{originalSource:`{
  args: {
...
}`,...(Ae=(Re=V.parameters)==null?void 0:Re.docs)==null?void 0:Ae.source}}};var Ge,qe,Me;I.parameters={...I.parameters,docs:{...(Ge=I.parameters)==null?void 0:Ge.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(Me=(qe=I.parameters)==null?void 0:qe.docs)==null?void 0:Me.source}}};var ke,Fe,Ve;z.parameters={...z.parameters,docs:{...(ke=z.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  args: {
    localDataCount: 100000,
    isTextWrapData: true,
    columns: muicolumns,
...
}`,...(Oe=(ze=O.parameters)==null?void 0:ze.docs)==null?void 0:Oe.source}}};var Pe,je,We;P.parameters={...P.parameters,docs:{...(Pe=P.parameters)==null?void 0:Pe.docs,source:{originalSource:`{
  args: {
    // localDataCount: 100,
    dataSource: new DataManager({
...
}`,...(We=(je=P.parameters)==null?void 0:je.docs)==null?void 0:We.source}}};var Ue,Be,Ne;j.parameters={...j.parameters,docs:{...(Ue=j.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
  args: {
    serverPageSize: 50,
    localDataCount: 5000,
    columns: columns.slice(1, 11),
...
}`,...(Ne=(Be=j.parameters)==null?void 0:Be.docs)==null?void 0:Ne.source}}};const Cn=["LocalData","OverComeBrowserLimit","UrlAdaptorData","WebApiAdaptorData","RowTemplate","TextWrapSample","GroupingSample","ODataV4Sample","CustomBindingSample"];export{j as CustomBindingSample,O as GroupingSample,M as LocalData,P as ODataV4Sample,k as OverComeBrowserLimit,I as RowTemplate,z as TextWrapSample,F as UrlAdaptorData,V as WebApiAdaptorData,Cn as __namedExportsOrder,vn as default};
