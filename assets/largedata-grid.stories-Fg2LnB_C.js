import{j as t}from"./index-B6UdnZfq.js";import{r as n}from"./index-2yJIXLcc.js";import{m as T,a as G,b as q,P as A,G as F,S as y,Q as k,D as S,U as V,W as M}from"./data-ZLcXqvdS.js";import"./index-Bn05qqr6.js";const I=[40,80,120,200],s=e=>{const b=n.useRef(null),[l,C]=n.useState(!1),[d,D]=n.useState(!1),a=n.useMemo(()=>T(100),[]),x=n.useMemo(()=>[{columns:G(a.length)}],[]),R=n.useMemo(()=>q(e.localDataCount,a),[e.localDataCount,a]);return t.jsxs("div",{style:{height:"96vh"},children:[t.jsxs("button",{onClick:()=>D(!d),children:[d?"Destroy":"Render"," Data Grid"]}),e.localDataCount&&t.jsxs("button",{onClick:()=>C(!l),children:["Dynamic Row Height ",l?"Enabled":"Disabled"]}),d&&t.jsx(A,{dir:e.enableRtl?"rtl":"ltr",children:t.jsx(F,{ref:b,dataSource:e.localDataCount?R:[],columns:e.localDataCount?a:[],aggregates:e.localDataCount?x:null,...e,getRowHeight:l?E=>I[E.rowIndex%4]:null})})]})};try{s.displayName="LargeDataGridTest",s.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{localDataCount:{defaultValue:null,description:"",name:"localDataCount",required:!1,type:{name:"number"}},id:{defaultValue:{value:"React.useId()"},description:`Specifies a unique identifier for the grid component.
...
\`\`\``,name:"onDataChangeCancel",required:!1,type:{name:"(event: FormCancelEvent<unknown>) => void"}}}}}catch{}const U={title:"Grid/VirtualGridBase",component:s,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["1000","10000","100000"],description:"Grid Local DataSource Count"}}},r={args:{localDataCount:1e5,editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%"}},o={args:{dataSource:new S({url:"https://ej2services.syncfusion.com/react/hotfix/api/UrlDataSource",adaptor:new V}),query:new k().addParams("dataCount","100000"),columns:[{field:"EmployeeID",visible:!1,headerText:"Employee ID",isPrimaryKey:!0,width:"130"},{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"},{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"},{field:"Mail",headerText:"Mail",width:"230"},{field:"Location",headerText:"Location",width:"140"},{field:"Status",headerText:"Status",width:"130"},{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"},{field:"Rating",headerText:"Rating",width:"220"},{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"},{field:"CurrentSalary",headerText:"Current Salary",width:"160",format:"C2"},{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"}],toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{enableCache:!1},scrollMode:y.Virtual,height:"100%"}},i={args:{dataSource:new S({url:"https://ej2services.syncfusion.com/react/hotfix/api/GridWebAPIService",adaptor:new M}),columns:[{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130"},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip"},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowFilter:!1,allowSort:!1}],toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},scrollMode:y.Virtual,height:"100%"}};var u,c,p;r.parameters={...r.parameters,docs:{...(u=r.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
...
}`,...(p=(c=r.parameters)==null?void 0:c.docs)==null?void 0:p.source}}};var h,m,g;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
...
}`,...(g=(m=o.parameters)==null?void 0:m.docs)==null?void 0:g.source}}};var f,w,v;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(v=(w=i.parameters)==null?void 0:w.docs)==null?void 0:v.source}}};const H=["LocalData","UrlAdaptorData","WebApiAdaptorData"];export{r as LocalData,o as UrlAdaptorData,i as WebApiAdaptorData,H as __namedExportsOrder,U as default};
