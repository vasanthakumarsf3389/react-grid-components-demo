import{j as e}from"./index-B6UdnZfq.js";import{r as a}from"./index-2yJIXLcc.js";import{m as G,P as q,G as A,a as F,b as k,S,Q as V,D as C,C as I,c as n,U as M,W as P}from"./data-DEpL-Sxn.js";import"./index-Bn05qqr6.js";const z=[40,80,120,200],s=t=>{var u;const x=a.useRef(null),[l,D]=a.useState(!0),[d,R]=a.useState(!1),E=a.useMemo(()=>G(t.localDataCount,t.columns),[t.localDataCount,(u=t.columns)==null?void 0:u.length]);return e.jsxs("div",{style:{height:"96vh"},children:[e.jsxs("button",{onClick:()=>R(!d),children:[d?"Destroy":"Render"," Data Grid"]}),t.localDataCount&&e.jsxs("button",{onClick:()=>D(!l),children:[l?"Uniform":"Non Uniform"," Row Height Applied"]}),d&&e.jsx(q,{dir:t.enableRtl?"rtl":"ltr",children:e.jsx(A,{ref:x,dataSource:t.localDataCount?E:[],...t,getRowHeight:l?null:T=>z[T.rowIndex%4],children:t.children})})]})};try{s.displayName="LargeDataGridTest",s.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{localDataCount:{defaultValue:null,description:"",name:"localDataCount",required:!1,type:{name:"number"}},id:{defaultValue:{value:"React.useId()"},description:`Specifies a unique identifier for the grid component.
...
}`,...(h=(p=r.parameters)==null?void 0:p.docs)==null?void 0:h.source}}};var m,g,f;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
...
}`,...(f=(g=o.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};var w,v,y;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(y=(v=i.parameters)==null?void 0:v.docs)==null?void 0:y.source}}};const O=["LocalData","UrlAdaptorData","WebApiAdaptorData"];export{r as LocalData,o as UrlAdaptorData,i as WebApiAdaptorData,O as __namedExportsOrder,N as default};
