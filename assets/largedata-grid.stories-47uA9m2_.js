import{j as e}from"./index-B6UdnZfq.js";import{r as o}from"./index-2yJIXLcc.js";import{m as Q,D as x,P as J,G as K,a as X,b as $,S as z,Q as Y,c as N,e as Z,C as v,d as n,A as ee,f as ne,g as te,U as ae,W as re,T as D,h as oe,i as d,j as c}from"./data-9YYJw9AR.js";import"./index-Bn05qqr6.js";const ie=[40,80,120,200],y=t=>{var b;const{enableRtl:r,enableRipple:L,localDataCount:l,isDialogInsideGrid:S,isStrictMode:U,isMultipleChildren:W,...a}=t,C=o.useRef(null),g=o.useRef(null),[f,H]=o.useState(!0),[w,O]=o.useState(!1),B=o.useMemo(()=>Q(l,a.columns),[l,(b=a.columns)==null?void 0:b.length]),s=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>O(!w),children:[w?"Destroy":"Render"," Data Grid"]}),l&&e.jsxs("button",{onClick:()=>H(!f),children:[f?"Uniform":"Non Uniform"," Row Height Applied"]}),w&&e.jsx(J,{dir:r?"rtl":"ltr",ripple:L,children:e.jsx(K,{ref:C,dataSource:l?B:[],...a,columns:a.children?void 0:a.columns,aggregates:a.children?void 0:a.aggregates,getRowHeight:f?null:_=>ie[_.rowIndex%4],children:W?a.children.props.children:a.children})}),e.jsx("button",{onClick:()=>console.log(C),children:"dummy navigation checking button"})]});return e.jsx("div",{ref:g,style:{height:"93vh"},children:U?e.jsx(o.StrictMode,{children:S?e.jsx(x,{open:!0,fullScreen:!0,target:g.current,children:s()}):s()}):S?e.jsx(x,{open:!0,fullScreen:!0,target:g.current,children:s()}):s()})};try{y.displayName="LargeDataGridTest",y.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
\`\`\``,name:"onDataChangeCancel",required:!1,type:{name:"(event: FormCancelEvent<unknown>) => void"}}}}}catch{}const ue={title:"Grid/VirtualGridBase",component:y,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","100","1000","10000","100000"],description:"Grid Local DataSource Count"}}},i=$(100,!1);i.unshift({type:oe.Checkbox,width:50,allowFilter:!1});i.push({headerText:"Command Actions",width:200,getCommandItems:()=>[e.jsx(d,{type:c.Edit},"Edit"),e.jsx(d,{type:c.Delete},"Delete"),e.jsx(d,{type:c.Update},"Update"),e.jsx(d,{type:c.Cancel},"Cancel")]});const R=[{columns:X(i.length)}],u={args:{localDataCount:1e5,columns:i,aggregates:R,isMultipleChildren:!0,children:e.jsxs(e.Fragment,{children:[e.jsx(v,{children:i.map((t,r)=>e.jsx(n,{...t},r))}),e.jsx(ee,{children:R.map(t=>e.jsx(ne,{children:t.columns.map(r=>e.jsx(te,{...r}))}))})]}),editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%"}},p={args:{dataSource:new N({url:"https://ej2services.syncfusion.com/react/hotfix/api/UrlDataSource",adaptor:new ae}),query:new Y().addParams("dataCount","100000"),toolbar:["Search"],children:e.jsxs(v,{children:[e.jsx(n,{field:"EmployeeID",visible:!1,headerText:"Employee ID",isPrimaryKey:!0,width:"130"}),e.jsx(n,{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"}),e.jsx(n,{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"}),e.jsx(n,{field:"Mail",headerText:"Mail",width:"230"}),e.jsx(n,{field:"Location",headerText:"Location",width:"140"}),e.jsx(n,{field:"Status",headerText:"Status",width:"130"}),e.jsx(n,{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"}),e.jsx(n,{field:"Rating",headerText:"Rating",width:"220"}),e.jsx(n,{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"}),e.jsx(n,{field:"CurrentSalary",headerText:"Current Salary",width:"160",format:"C2"}),e.jsx(n,{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"})]}),selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{enableCache:!1,scrollMode:z.Virtual},height:"100%"}},m={args:{dataSource:new N({url:"https://ej2services.syncfusion.com/react/hotfix/api/GridWebAPIService",adaptor:new re}),columns:[{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130",allowSearch:!1},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1}],selectionSettings:{mode:"Single"},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{scrollMode:z.Virtual},height:"100%"}},h={args:{dataSource:Z,children:e.jsxs(v,{children:[e.jsx(n,{headerText:"Employee Image",width:"180",textAlign:D.Center,field:"EmployeeID"}),e.jsx(n,{headerText:"Employee Details",width:"300",textAlign:D.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:t=>{const r=`https://npmci-react.syncfusion.com/development-react-ui/images/grid/${t.EmployeeID}.png`;return e.jsxs("tr",{className:"templateRow",children:[e.jsx("td",{className:"photo",children:e.jsx("img",{src:r,alt:t.EmployeeID.toString()})}),e.jsx("td",{className:"details",children:e.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"30%"}}),e.jsx("col",{style:{width:"10%"}})]}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"First Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:t.FirstName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Last Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:t.LastName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Title"}),e.jsx("td",{children:":"}),e.jsx("td",{children:t.Title})]})]})]})})]})}}};var E,T,G;u.parameters={...u.parameters,docs:{...(E=u.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    ...
    children: <>\r
                <Columns>\r
                    {columns.map((col, index) => <Column key={index} {...col} />)}\r
                </Columns>\r
                <Aggregates>{aggregates.map(row => <AggregateRow>{row.columns.map(col => <AggregateColumn {...col} />)}</AggregateRow>)}</Aggregates>\r
            </>,
...
}`,...(G=(T=u.parameters)==null?void 0:T.docs)==null?void 0:G.source}}};var A,q,F;p.parameters={...p.parameters,docs:{...(A=p.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
...
}`,...(F=(q=p.parameters)==null?void 0:q.docs)==null?void 0:F.source}}};var k,V,j;m.parameters={...m.parameters,docs:{...(k=m.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(j=(V=m.parameters)==null?void 0:V.docs)==null?void 0:j.source}}};var I,M,P;h.parameters={...h.parameters,docs:{...(I=h.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(P=(M=h.parameters)==null?void 0:M.docs)==null?void 0:P.source}}};const pe=["LocalData","UrlAdaptorData","WebApiAdaptorData","RowTemplate"];export{u as LocalData,h as RowTemplate,p as UrlAdaptorData,m as WebApiAdaptorData,pe as __namedExportsOrder,ue as default};
