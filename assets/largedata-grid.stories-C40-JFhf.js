import{j as e}from"./index-C6j-OS9u.js";import{r as i}from"./index-CtNveh2g.js";import{C as r,a as o,m as ne,D as A,P as te,G as ae,b as re,c as oe,S as B,Q as ie,d as _,e as le,f as v,g as n,U as se,W as de,T as I,h as ue}from"./data-DcOwj71h.js";import"./index-LwkqeIug.js";const ce=[40,80,120,200],S=a=>{var b,D,R,E,T;const{enableRtl:g,enableRipple:K,localDataCount:l,isDialogInsideGrid:C,isStrictMode:J,isMultipleChildren:Q,parentContainerHeight:X="93vh",...t}=a;((R=(D=t.columns)==null?void 0:D[((b=t.columns)==null?void 0:b.length)-1])==null?void 0:R.headerText)==="Command Actions"&&(t.columns[((E=t.columns)==null?void 0:E.length)-1].getCommandItems=()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]);const x=i.useRef(null),f=i.useRef(null),[w,$]=i.useState(!0),[y,Y]=i.useState(!1),Z=i.useMemo(()=>ne(l,t.columns),[l,(T=t.columns)==null?void 0:T.length]),s=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>Y(!y),children:[y?"Destroy":"Render"," Data Grid"]}),l&&e.jsxs("button",{onClick:()=>$(!w),children:[w?"Uniform":"Non Uniform"," Row Height Applied"]}),y&&e.jsx(te,{dir:g?"rtl":"ltr",ripple:K,locale:t.locale,children:e.jsx(ae,{ref:x,dataSource:l?Z:[],...t,columns:t.children?void 0:t.columns,aggregates:t.children?void 0:t.aggregates,getRowHeight:w?null:ee=>ce[ee.rowIndex%4],children:Q?t.children.props.children:t.children})}),e.jsx("button",{onClick:()=>{console.log(x)},children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:f,style:{height:X},children:J?e.jsx(i.StrictMode,{children:C?e.jsx(A,{open:!0,fullScreen:!0,target:f.current,children:s()}):s()}):C?e.jsx(A,{open:!0,fullScreen:!0,target:f.current,children:s()}):s()})};try{S.displayName="LargeDataGridTest",S.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
\`\`\``,name:"onDataChangeCancel",required:!1,type:{name:"(event: FormCancelEvent<unknown>) => void"}}}}}catch{}const we={title:"Grid/VirtualGridBase",component:S,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","100","1000","10000","100000"],description:"Grid Local DataSource Count"}}},h=oe(100,!1),pe=[{columns:re(h.length)}];h.unshift({type:ue.Checkbox,width:50,allowFilter:!1});h.push({headerText:"Command Actions",width:200,getCommandItems:()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]});const d={args:{localDataCount:1e5,columns:h,aggregates:pe,editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%"}},u={args:{dataSource:new _({url:"https://ej2services.syncfusion.com/react/hotfix/api/UrlDataSource",adaptor:new se}),query:new ie().addParams("dataCount","100000"),toolbar:["Search"],children:e.jsxs(v,{children:[e.jsx(n,{field:"EmployeeID",visible:!1,headerText:"Employee ID",isPrimaryKey:!0,width:"130"}),e.jsx(n,{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"}),e.jsx(n,{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"}),e.jsx(n,{field:"Mail",headerText:"Mail",width:"230"}),e.jsx(n,{field:"Location",headerText:"Location",width:"140"}),e.jsx(n,{field:"Status",headerText:"Status",width:"130"}),e.jsx(n,{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"}),e.jsx(n,{field:"Rating",headerText:"Rating",width:"220"}),e.jsx(n,{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"}),e.jsx(n,{field:"CurrentSalary",headerText:"Current Salary",width:"160",format:"C2"}),e.jsx(n,{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"})]}),selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{enableCache:!1,scrollMode:B.Virtual},height:"100%"}},c={args:{dataSource:new _({url:"https://ej2services.syncfusion.com/react/hotfix/api/GridWebAPIService",adaptor:new de}),columns:[{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130",allowSearch:!1},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1}],selectionSettings:{mode:"Single"},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{scrollMode:B.Virtual},height:"100%"}},p={args:{dataSource:le,children:e.jsxs(v,{children:[e.jsx(n,{headerText:"Employee Image",width:"180",textAlign:I.Center,field:"EmployeeID"}),e.jsx(n,{headerText:"Employee Details",width:"300",textAlign:I.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:a=>{const g=`https://npmci-react.syncfusion.com/development-react-ui/images/grid/${a.EmployeeID}.png`;return e.jsxs("tr",{className:"templateRow",children:[e.jsx("td",{className:"photo",children:e.jsx("img",{src:g,alt:a.EmployeeID.toString()})}),e.jsx("td",{className:"details",children:e.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"30%"}}),e.jsx("col",{style:{width:"10%"}})]}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"First Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.FirstName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Last Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.LastName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Title"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.Title})]})]})]})})]})}}},m={args:{dataSource:[{OrderID:1,CustomerID:"A"},{OrderID:2,CustomerID:"B"},{OrderID:3,CustomerID:"C"},{OrderID:4,CustomerID:"D"},{OrderID:5,CustomerID:"E"},{OrderID:6,CustomerID:"F"}],height:400,pageSettings:{enabled:!0,pageSize:3},selectionSettings:{mode:"Multiple"},children:e.jsxs(v,{children:[e.jsx(n,{type:"checkbox",width:"50"}),e.jsx(n,{field:"OrderID",headerText:"Order ID",isPrimaryKey:!0,width:"120"}),e.jsx(n,{field:"CustomerID",headerText:"Customer",width:"140"})]})}};var G,q,F;d.parameters={...d.parameters,docs:{...(G=d.parameters)==null?void 0:G.docs,source:{originalSource:`{
  args: {
...
}`,...(F=(q=d.parameters)==null?void 0:q.docs)==null?void 0:F.source}}};var k,V,j;u.parameters={...u.parameters,docs:{...(k=u.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
...
}`,...(j=(V=u.parameters)==null?void 0:V.docs)==null?void 0:j.source}}};var M,P,z;c.parameters={...c.parameters,docs:{...(M=c.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(z=(P=c.parameters)==null?void 0:P.docs)==null?void 0:z.source}}};var N,U,L;p.parameters={...p.parameters,docs:{...(N=p.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(L=(U=p.parameters)==null?void 0:U.docs)==null?void 0:L.source}}};var O,H,W;m.parameters={...m.parameters,docs:{...(O=m.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    dataSource: [{
      OrderID: 1,
      CustomerID: 'A'
...
}`,...(W=(H=m.parameters)==null?void 0:H.docs)==null?void 0:W.source}}};const ye=["LocalData","UrlAdaptorData","WebApiAdaptorData","RowTemplate","TestSample"];export{d as LocalData,p as RowTemplate,m as TestSample,u as UrlAdaptorData,c as WebApiAdaptorData,ye as __namedExportsOrder,we as default};
