import{j as e}from"./index-C6j-OS9u.js";import{r as i}from"./index-CtNveh2g.js";import{C as r,a as o,m as X,D as E,P as $,G as Y,b as Z,c as ee,S as L,Q as ne,d as U,e as te,f as W,g as t,U as ae,W as re,T,h as oe}from"./data-B-QFGjeV.js";import"./index-LwkqeIug.js";const ie=[40,80,120,200],y=a=>{var C,b,x,D,R;const{enableRtl:m,enableRipple:H,localDataCount:h,isDialogInsideGrid:v,isStrictMode:O,isMultipleChildren:B,parentContainerHeight:_="93vh",...n}=a;((x=(b=n.columns)==null?void 0:b[((C=n.columns)==null?void 0:C.length)-1])==null?void 0:x.headerText)==="Command Actions"&&(n.columns[((D=n.columns)==null?void 0:D.length)-1].getCommandItems=()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]);const S=i.useRef(null),g=i.useRef(null),[Q,se]=i.useState(!0),[f,J]=i.useState(!1),K=i.useMemo(()=>X(h,n.columns),[h,(R=n.columns)==null?void 0:R.length]),l=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>J(!f),children:[f?"Destroy":"Render"," Data Grid"]}),f&&e.jsx($,{dir:m?"rtl":"ltr",ripple:H,locale:n.locale,children:e.jsx(Y,{ref:S,dataSource:h?K:[],...n,columns:n.children?void 0:n.columns,aggregates:n.children?void 0:n.aggregates,onRowSelect:w=>{console.log(w.data)},getRowHeight:Q?null:w=>ie[w.rowIndex%4],children:B?n.children.props.children:n.children})}),e.jsx("button",{onClick:()=>console.log(S),children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:g,style:{height:_},children:O?e.jsx(i.StrictMode,{children:v?e.jsx(E,{open:!0,fullScreen:!0,target:g.current,children:l()}):l()}):v?e.jsx(E,{open:!0,fullScreen:!0,target:g.current,children:l()}):l()})};try{y.displayName="LargeDataGridTest",y.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
}`,...(q=(A=s.parameters)==null?void 0:A.docs)==null?void 0:q.source}}};var F,k,V;d.parameters={...d.parameters,docs:{...(F=d.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
...
}`,...(V=(k=d.parameters)==null?void 0:k.docs)==null?void 0:V.source}}};var I,j,M;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(M=(j=c.parameters)==null?void 0:j.docs)==null?void 0:M.source}}};var P,z,N;u.parameters={...u.parameters,docs:{...(P=u.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(N=(z=u.parameters)==null?void 0:z.docs)==null?void 0:N.source}}};const he=["LocalData","UrlAdaptorData","WebApiAdaptorData","RowTemplate"];export{s as LocalData,u as RowTemplate,d as UrlAdaptorData,c as WebApiAdaptorData,he as __namedExportsOrder,me as default};
