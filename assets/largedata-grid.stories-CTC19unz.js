import{j as e}from"./index-C6j-OS9u.js";import{r as i}from"./index-CtNveh2g.js";import{C as r,a as o,m as ne,D as I,P as te,G as ae,b as re,c as oe,S as _,Q as ie,d as K,e as le,f as x,g as n,U as se,W as de,T as G,h as ue}from"./data-DcOwj71h.js";import"./index-LwkqeIug.js";const ce=[40,80,120,200],C=a=>{var D,R,T,E,A;const{enableRtl:w,enableRipple:J,localDataCount:l,isDialogInsideGrid:b,isStrictMode:Q,isMultipleChildren:X,parentContainerHeight:$="93vh",...t}=a;((T=(R=t.columns)==null?void 0:R[((D=t.columns)==null?void 0:D.length)-1])==null?void 0:T.headerText)==="Command Actions"&&(t.columns[((E=t.columns)==null?void 0:E.length)-1].getCommandItems=()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]);const s=i.useRef(null),y=i.useRef(null),[S,Y]=i.useState(!0),[v,Z]=i.useState(!1),ee=i.useMemo(()=>ne(l,t.columns),[l,(A=t.columns)==null?void 0:A.length]),d=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>Z(!v),children:[v?"Destroy":"Render"," Data Grid"]}),l&&e.jsxs("button",{onClick:()=>Y(!S),children:[S?"Uniform":"Non Uniform"," Row Height Applied"]}),e.jsx("button",{onClick:()=>s.current.goToPage(2),children:"Go To Page 2"}),e.jsx("button",{onClick:()=>s.current.goToPage(1),children:"Go To Page 1"}),v&&e.jsx(te,{dir:w?"rtl":"ltr",ripple:J,locale:t.locale,children:e.jsx(ae,{ref:s,dataSource:l?ee:[],...t,columns:t.children?void 0:t.columns,aggregates:t.children?void 0:t.aggregates,getRowHeight:S?null:u=>ce[u.rowIndex%4],children:X?t.children.props.children:t.children})}),e.jsx("button",{onClick:()=>{var u;console.log((u=s.current)==null?void 0:u.getSelectedRowIndexes())},children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:y,style:{height:$},children:Q?e.jsx(i.StrictMode,{children:b?e.jsx(I,{open:!0,fullScreen:!0,target:y.current,children:d()}):d()}):b?e.jsx(I,{open:!0,fullScreen:!0,target:y.current,children:d()}):d()})};try{C.displayName="LargeDataGridTest",C.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
\`\`\``,name:"onDataChangeCancel",required:!1,type:{name:"(event: FormCancelEvent<unknown>) => void"}}}}}catch{}const we={title:"Grid/VirtualGridBase",component:C,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","100","1000","10000","100000"],description:"Grid Local DataSource Count"}}},f=oe(100,!1),pe=[{columns:re(f.length)}];f.unshift({type:ue.Checkbox,width:50,allowFilter:!1});f.push({headerText:"Command Actions",width:200,getCommandItems:()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]});const c={args:{localDataCount:1e5,columns:f,aggregates:pe,editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%"}},p={args:{dataSource:new K({url:"https://ej2services.syncfusion.com/react/hotfix/api/UrlDataSource",adaptor:new se}),query:new ie().addParams("dataCount","100000"),toolbar:["Search"],children:e.jsxs(x,{children:[e.jsx(n,{field:"EmployeeID",visible:!1,headerText:"Employee ID",isPrimaryKey:!0,width:"130"}),e.jsx(n,{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"}),e.jsx(n,{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"}),e.jsx(n,{field:"Mail",headerText:"Mail",width:"230"}),e.jsx(n,{field:"Location",headerText:"Location",width:"140"}),e.jsx(n,{field:"Status",headerText:"Status",width:"130"}),e.jsx(n,{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"}),e.jsx(n,{field:"Rating",headerText:"Rating",width:"220"}),e.jsx(n,{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"}),e.jsx(n,{field:"CurrentSalary",headerText:"Current Salary",width:"160",format:"C2"}),e.jsx(n,{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"})]}),selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{enableCache:!1,scrollMode:_.Virtual},height:"100%"}},m={args:{dataSource:new K({url:"https://ej2services.syncfusion.com/react/hotfix/api/GridWebAPIService",adaptor:new de}),columns:[{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130",allowSearch:!1},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1}],selectionSettings:{mode:"Single"},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{scrollMode:_.Virtual},height:"100%"}},h={args:{dataSource:le,children:e.jsxs(x,{children:[e.jsx(n,{headerText:"Employee Image",width:"180",textAlign:G.Center,field:"EmployeeID"}),e.jsx(n,{headerText:"Employee Details",width:"300",textAlign:G.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:a=>{const w=`https://npmci-react.syncfusion.com/development-react-ui/images/grid/${a.EmployeeID}.png`;return e.jsxs("tr",{className:"templateRow",children:[e.jsx("td",{className:"photo",children:e.jsx("img",{src:w,alt:a.EmployeeID.toString()})}),e.jsx("td",{className:"details",children:e.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"30%"}}),e.jsx("col",{style:{width:"10%"}})]}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"First Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.FirstName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Last Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.LastName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Title"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.Title})]})]})]})})]})}}},g={args:{dataSource:[{OrderID:1,CustomerID:"A"},{OrderID:2,CustomerID:"B"},{OrderID:3,CustomerID:"C"},{OrderID:4,CustomerID:"D"},{OrderID:5,CustomerID:"E"},{OrderID:6,CustomerID:"F"}],height:400,pageSettings:{enabled:!0,pageSize:3},selectionSettings:{mode:"Multiple"},children:e.jsxs(x,{children:[e.jsx(n,{type:"checkbox",width:"50"}),e.jsx(n,{field:"OrderID",headerText:"Order ID",isPrimaryKey:!0,width:"120"}),e.jsx(n,{field:"CustomerID",headerText:"Customer",width:"140"})]})}};var q,F,k;c.parameters={...c.parameters,docs:{...(q=c.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
...
}`,...(k=(F=c.parameters)==null?void 0:F.docs)==null?void 0:k.source}}};var V,j,M;p.parameters={...p.parameters,docs:{...(V=p.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
...
}`,...(M=(j=p.parameters)==null?void 0:j.docs)==null?void 0:M.source}}};var P,z,N;m.parameters={...m.parameters,docs:{...(P=m.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(N=(z=m.parameters)==null?void 0:z.docs)==null?void 0:N.source}}};var U,L,O;h.parameters={...h.parameters,docs:{...(U=h.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(O=(L=h.parameters)==null?void 0:L.docs)==null?void 0:O.source}}};var H,W,B;g.parameters={...g.parameters,docs:{...(H=g.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    dataSource: [{
      OrderID: 1,
      CustomerID: 'A'
    ...
    children: <Columns>\r
          <Column type="checkbox" width="50" />\r
          <Column field="OrderID" headerText="Order ID" isPrimaryKey={true} width="120" />\r
          <Column field="CustomerID" headerText="Customer" width="140" />\r
        </Columns>
    ...
    // dataSource: gadgetsPurchaseData,
...
}`,...(B=(W=g.parameters)==null?void 0:W.docs)==null?void 0:B.source}}};const ye=["LocalData","UrlAdaptorData","WebApiAdaptorData","RowTemplate","TestSample"];export{c as LocalData,h as RowTemplate,g as TestSample,p as UrlAdaptorData,m as WebApiAdaptorData,ye as __namedExportsOrder,we as default};
