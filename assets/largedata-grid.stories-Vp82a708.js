import{j as e}from"./index-C6j-OS9u.js";import{r as i}from"./index-CtNveh2g.js";import{C as r,a as o,m as K,D as R,P as X,G as $,b as Y,c as Z,S as N,Q as ee,d as L,e as ne,f as U,g as t,U as te,W as ae,T as E,h as re}from"./data-368qPsLX.js";import"./index-LwkqeIug.js";const oe=[40,80,120,200],w=a=>{var S,C,b,x,D;const{enableRtl:m,enableRipple:W,localDataCount:h,isDialogInsideGrid:y,isStrictMode:H,isMultipleChildren:O,...n}=a;((b=(C=n.columns)==null?void 0:C[((S=n.columns)==null?void 0:S.length)-1])==null?void 0:b.headerText)==="Command Actions"&&(n.columns[((x=n.columns)==null?void 0:x.length)-1].getCommandItems=()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]);const v=i.useRef(null),g=i.useRef(null),[B,le]=i.useState(!0),[f,_]=i.useState(!1),Q=i.useMemo(()=>K(h,n.columns),[h,(D=n.columns)==null?void 0:D.length]),l=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>_(!f),children:[f?"Destroy":"Render"," Data Grid"]}),f&&e.jsx(X,{dir:m?"rtl":"ltr",ripple:W,children:e.jsx($,{ref:v,dataSource:h?Q:[],...n,columns:n.children?void 0:n.columns,aggregates:n.children?void 0:n.aggregates,getRowHeight:B?null:J=>oe[J.rowIndex%4],children:O?n.children.props.children:n.children})}),e.jsx("button",{onClick:()=>console.log(v),children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:g,style:{height:"93vh"},children:H?e.jsx(i.StrictMode,{children:y?e.jsx(R,{open:!0,fullScreen:!0,target:g.current,children:l()}):l()}):y?e.jsx(R,{open:!0,fullScreen:!0,target:g.current,children:l()}):l()})};try{w.displayName="LargeDataGridTest",w.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
}`,...(k=(F=d.parameters)==null?void 0:F.docs)==null?void 0:k.source}}};var V,I,j;c.parameters={...c.parameters,docs:{...(V=c.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(j=(I=c.parameters)==null?void 0:I.docs)==null?void 0:j.source}}};var M,P,z;u.parameters={...u.parameters,docs:{...(M=u.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(z=(P=u.parameters)==null?void 0:P.docs)==null?void 0:z.source}}};const me=["LocalData","UrlAdaptorData","WebApiAdaptorData","RowTemplate"];export{s as LocalData,u as RowTemplate,d as UrlAdaptorData,c as WebApiAdaptorData,me as __namedExportsOrder,pe as default};
