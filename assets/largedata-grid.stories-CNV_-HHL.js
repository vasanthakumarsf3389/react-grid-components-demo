import{j as e}from"./index-C6j-OS9u.js";import{r as i}from"./index-CtNveh2g.js";import{C as r,a as o,m as X,D as E,P as $,G as Y,b as Z,c as ee,S as L,Q as ne,d as U,e as te,f as W,g as t,U as ae,W as re,T,h as oe}from"./data-CEmAzDGb.js";import"./index-LwkqeIug.js";const ie=[40,80,120,200],y=a=>{var C,b,x,D,R;const{enableRtl:h,enableRipple:H,localDataCount:l,isDialogInsideGrid:v,isStrictMode:O,isMultipleChildren:B,...n}=a;((x=(b=n.columns)==null?void 0:b[((C=n.columns)==null?void 0:C.length)-1])==null?void 0:x.headerText)==="Command Actions"&&(n.columns[((D=n.columns)==null?void 0:D.length)-1].getCommandItems=()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]);const S=i.useRef(null),g=i.useRef(null),[f,_]=i.useState(!0),[w,Q]=i.useState(!1),J=i.useMemo(()=>X(l,n.columns),[l,(R=n.columns)==null?void 0:R.length]),s=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>Q(!w),children:[w?"Destroy":"Render"," Data Grid"]}),l&&e.jsxs("button",{onClick:()=>_(!f),children:[f?"Uniform":"Non Uniform"," Row Height Applied"]}),w&&e.jsx($,{dir:h?"rtl":"ltr",ripple:H,children:e.jsx(Y,{ref:S,dataSource:l?J:[],...n,columns:n.children?void 0:n.columns,aggregates:n.children?void 0:n.aggregates,getRowHeight:f?null:K=>ie[K.rowIndex%4],children:B?n.children.props.children:n.children})}),e.jsx("button",{onClick:()=>console.log(S),children:"dummy navigation checking button"})]});return e.jsx("div",{ref:g,style:{height:"93vh"},children:O?e.jsx(i.StrictMode,{children:v?e.jsx(E,{open:!0,fullScreen:!0,target:g.current,children:s()}):s()}):v?e.jsx(E,{open:!0,fullScreen:!0,target:g.current,children:s()}):s()})};try{y.displayName="LargeDataGridTest",y.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
}`,...(q=(A=d.parameters)==null?void 0:A.docs)==null?void 0:q.source}}};var F,k,V;c.parameters={...c.parameters,docs:{...(F=c.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
...
}`,...(V=(k=c.parameters)==null?void 0:k.docs)==null?void 0:V.source}}};var j,I,M;u.parameters={...u.parameters,docs:{...(j=u.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(M=(I=u.parameters)==null?void 0:I.docs)==null?void 0:M.source}}};var P,z,N;p.parameters={...p.parameters,docs:{...(P=p.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(N=(z=p.parameters)==null?void 0:z.docs)==null?void 0:N.source}}};const me=["LocalData","UrlAdaptorData","WebApiAdaptorData","RowTemplate"];export{d as LocalData,p as RowTemplate,c as UrlAdaptorData,u as WebApiAdaptorData,me as __namedExportsOrder,pe as default};
