import{j as e}from"./index-B6UdnZfq.js";import{r}from"./index-2yJIXLcc.js";import{D as w,P,G as L,m as z,a as H,S as k,Q as U,b as O,e as W,C as f,c as n,U as B,W as _,T as y}from"./data-diBgeTlo.js";import"./index-Bn05qqr6.js";const K=[40,80,120,200],g=t=>{const a=r.useRef(null),h=r.useRef(null),[m,j]=r.useState(!0),[p,N]=r.useState(!1),o=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>N(!p),children:[p?"Destroy":"Render"," Data Grid"]}),t.localDataCount&&e.jsxs("button",{onClick:()=>j(!m),children:[m?"Uniform":"Non Uniform"," Row Height Applied"]}),e.jsx("button",{onClick:()=>{var i;return(i=a.current)==null?void 0:i.filterByColumn("CustomerID","contains","VI","and",!0,!1)},children:"filterByColumn('CustomerID', 'contains', 'VI', 'and', true, false)"}),e.jsx("button",{onClick:()=>a.current.clearFilter(["OrderID"]),children:"clearFilter(['OrderID'])"}),e.jsx("button",{onClick:()=>console.log(a.current.filterSettings.columns),children:"filterSettings.columns"}),p&&e.jsx(P,{dir:t.enableRtl?"rtl":"ltr",children:e.jsx(L,{ref:a,...t,getRowHeight:m?null:i=>K[i.rowIndex%4],children:t.children})}),e.jsx("button",{children:"dummy navigation checking button"})]});return e.jsx("div",{ref:h,style:{height:"93vh"},children:t.isStrictMode?e.jsx(r.StrictMode,{children:t.isDialogInsideGrid?e.jsx(w,{open:!0,fullScreen:!0,target:h.current,children:o()}):o()}):t.isDialogInsideGrid?e.jsx(w,{open:!0,fullScreen:!0,target:h.current,children:o()}):o()})};try{g.displayName="LargeDataGridTest",g.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{localDataCount:{defaultValue:null,description:"",name:"localDataCount",required:!1,type:{name:"number"}},isDialogInsideGrid:{defaultValue:null,description:"",name:"isDialogInsideGrid",required:!1,type:{name:"boolean"}},isStrictMode:{defaultValue:null,description:"",name:"isStrictMode",required:!1,type:{name:"boolean"}},id:{defaultValue:{value:"React.useId()"},description:`Specifies a unique identifier for the grid component.
...
\`\`\``,name:"onDataChangeCancel",required:!1,type:{name:"(event: FormCancelEvent<unknown>) => void"}}}}}catch{}const Z={title:"Grid/VirtualGridBase",component:g,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["1000","10000","100000"],description:"Grid Local DataSource Count"}}},M=H(100),Q=[{columns:z(M.length)}],l={args:{localDataCount:1e5,columns:M,aggregates:Q,editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%"}},d={args:{dataSource:new O({url:"https://ej2services.syncfusion.com/react/hotfix/api/UrlDataSource",adaptor:new B}),query:new U().addParams("dataCount","100000"),toolbar:["Search"],children:e.jsxs(f,{children:[e.jsx(n,{field:"EmployeeID",visible:!1,headerText:"Employee ID",isPrimaryKey:!0,width:"130"}),e.jsx(n,{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"}),e.jsx(n,{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"}),e.jsx(n,{field:"Mail",headerText:"Mail",width:"230"}),e.jsx(n,{field:"Location",headerText:"Location",width:"140"}),e.jsx(n,{field:"Status",headerText:"Status",width:"130"}),e.jsx(n,{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"}),e.jsx(n,{field:"Rating",headerText:"Rating",width:"220"}),e.jsx(n,{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"}),e.jsx(n,{field:"CurrentSalary",headerText:"Current Salary",width:"160",format:"C2"}),e.jsx(n,{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"})]}),selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{enableCache:!1,scrollMode:k.Virtual},height:"100%"}},s={args:{dataSource:new O({url:"https://ej2services.syncfusion.com/react/hotfix/api/GridWebAPIService",adaptor:new _}),columns:[{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130"},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip"},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowFilter:!1,allowSort:!1}],toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{scrollMode:k.Virtual},height:"100%"}},u={args:{dataSource:W,children:e.jsxs(f,{children:[e.jsx(n,{headerText:"Employee Image",width:"180",textAlign:y.Center,field:"EmployeeID"}),e.jsx(n,{headerText:"Employee Details",width:"300",textAlign:y.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:t=>{const a=`https://npmci-react.syncfusion.com/images/grid/${t.EmployeeID}.png`;return e.jsxs("tr",{className:"templateRow",children:[e.jsx("td",{className:"photo",children:e.jsx("img",{src:a,alt:t.EmployeeID.toString()})}),e.jsx("td",{className:"details",children:e.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"30%"}}),e.jsx("col",{style:{width:"10%"}})]}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"First Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:t.FirstName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Last Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:t.LastName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Title"}),e.jsx("td",{children:":"}),e.jsx("td",{children:t.Title})]})]})]})})]})}}},c={args:{dataSource:[{OrderID:10248,CustomerID:"VINET",Freight:32.38,OrderDate:new Date("1996-07-04")},{OrderID:10249,CustomerID:"TOMSP",Freight:11.61,OrderDate:new Date("1996-07-05")},{OrderID:10250,CustomerID:"HANAR",Freight:65.83,OrderDate:new Date("1996-07-08")},{OrderID:10251,CustomerID:"VICTE",Freight:41.34,OrderDate:new Date("1996-07-08")},{OrderID:10252,CustomerID:"SUPRD",Freight:51.3,OrderDate:new Date("1996-07-09")}],height:400,width:800,filterSettings:{enabled:!0,type:"FilterBar",columns:[{field:"CustomerID",operator:"contains",value:"VI",predicate:"or"},{field:"OrderID",operator:"greaterThan",value:10249,predicate:"or"},{field:"OrderDate",operator:"equal",value:new Date("1996-07-08"),predicate:"or"}]},children:e.jsxs(f,{children:[e.jsx(n,{field:"OrderID",headerText:"Order ID",width:"120",allowFilter:!0,type:"number"}),e.jsx(n,{field:"CustomerID",headerText:"Customer ID",width:"150",allowFilter:!0,type:"string"}),e.jsx(n,{field:"Freight",headerText:"Freight",width:"100",allowFilter:!0,type:"number"}),e.jsx(n,{field:"OrderDate",headerText:"OrderDate",type:"date",format:"M/d/yyyy",width:"100",allowFilter:!0})]}),pageSettings:{enabled:!0}}};var S,C,v;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
...
}`,...(v=(C=l.parameters)==null?void 0:C.docs)==null?void 0:v.source}}};var D,x,b;d.parameters={...d.parameters,docs:{...(D=d.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
...
}`,...(b=(x=d.parameters)==null?void 0:x.docs)==null?void 0:b.source}}};var T,R,F;s.parameters={...s.parameters,docs:{...(T=s.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(F=(R=s.parameters)==null?void 0:R.docs)==null?void 0:F.source}}};var E,I,G;u.parameters={...u.parameters,docs:{...(E=u.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(G=(I=u.parameters)==null?void 0:I.docs)==null?void 0:G.source}}};var A,q,V;c.parameters={...c.parameters,docs:{...(A=c.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    dataSource: [{
      OrderID: 10248,
      CustomerID: 'VINET',
...
}`,...(V=(q=c.parameters)==null?void 0:q.docs)==null?void 0:V.source}}};const ee=["LocalData","UrlAdaptorData","WebApiAdaptorData","RowTemplate","TestSample"];export{l as LocalData,u as RowTemplate,c as TestSample,d as UrlAdaptorData,s as WebApiAdaptorData,ee as __namedExportsOrder,Z as default};
