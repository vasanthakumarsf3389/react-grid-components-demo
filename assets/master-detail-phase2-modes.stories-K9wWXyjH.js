...
\`\`\``,...(x=(C=g.parameters)==null?void 0:C.docs)==null?void 0:x.description}}};var y,w,R,P,M;m.parameters={...m.parameters,docs:{...(y=m.parameters)==null?void 0:y.docs,source:{originalSource:`() => {
  const gridRef = useRef<GridRef<Order>>(null);
...
}`,...(R=(w=m.parameters)==null?void 0:w.docs)==null?void 0:R.source},description:{story:`Story: Mode 2 - Mapping Data Binding with mappingID\r
\r
...
\`\`\``,...(M=(P=m.parameters)==null?void 0:P.docs)==null?void 0:M.description}}};var v,N,L,T,S;h.parameters={...h.parameters,docs:{...(v=h.parameters)==null?void 0:v.docs,source:{originalSource:`() => {
  const gridRef = useRef<GridRef<Order>>(null);
...
\`\`\``,...(S=(T=h.parameters)==null?void 0:T.docs)==null?void 0:S.description}}};var A,$,G,F,k;D.parameters={...D.parameters,docs:{...(A=D.parameters)==null?void 0:A.docs,source:{originalSource:`() => {
  const gridRef = useRef<GridRef<Order>>(null);
...
}`,...(G=($=D.parameters)==null?void 0:$.docs)==null?void 0:G.source},description:{story:`Story: Advanced - Three-Level Nesting\r
\r
...
\`\`\``,...(k=(F=D.parameters)==null?void 0:F.docs)==null?void 0:k.description}}};const K=["MasterDetailMode1NestedData","MasterDetailMode2MappingData","MasterDetailMode3AsyncData","MasterDetailAdvancedThreeLevelNesting"];export{D as MasterDetailAdvancedThreeLevelNesting,g as MasterDetailMode1NestedData,m as MasterDetailMode2MappingData,h as MasterDetailMode3AsyncData,K as __namedExportsOrder,V as default};
