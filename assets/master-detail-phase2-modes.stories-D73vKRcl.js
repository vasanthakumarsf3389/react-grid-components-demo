import{j as t}from"./index-CTAXdLKx.js";import{r as u}from"./index-D5jfS-9e.js";import{u as p,G as f}from"./useGridTheme-BCOLcQCg.js";import"./client-Spw3EFno.js";const K={title:"Grid/Master-Detail/Phase 2 - Data Binding Modes",parameters:{docs:{description:{component:`
...
}`,...(C=(O=g.parameters)==null?void 0:O.docs)==null?void 0:C.source},description:{story:`Story: Mode 1 - Nested Data Binding\r
\r
...
\`\`\``,...(w=(x=g.parameters)==null?void 0:x.docs)==null?void 0:w.description}}};var y,R,P,M,v;D.parameters={...D.parameters,docs:{...(y=D.parameters)==null?void 0:y.docs,source:{originalSource:`() => {
  useGridTheme('material');
  const gridRef = useRef<GridRef<Order>>(null);
...
}`,...(P=(R=D.parameters)==null?void 0:R.docs)==null?void 0:P.source},description:{story:`Story: Mode 2 - Mapping Data Binding with mappingID\r
\r
...
\`\`\``,...(v=(M=D.parameters)==null?void 0:M.docs)==null?void 0:v.description}}};var N,T,L,S,A;h.parameters={...h.parameters,docs:{...(N=h.parameters)==null?void 0:N.docs,source:{originalSource:`() => {
  useGridTheme('material');
  const gridRef = useRef<GridRef<Order>>(null);
...
}`,...(L=(T=h.parameters)==null?void 0:T.docs)==null?void 0:L.source},description:{story:`Story: Mode 3 - Async Data Binding\r
\r
...
\`\`\``,...(A=(S=h.parameters)==null?void 0:S.docs)==null?void 0:A.description}}};var G,F,$,k,b;m.parameters={...m.parameters,docs:{...(G=m.parameters)==null?void 0:G.docs,source:{originalSource:`() => {
  useGridTheme('material');
  const gridRef = useRef<GridRef<Order>>(null);
...
}`,...($=(F=m.parameters)==null?void 0:F.docs)==null?void 0:$.source},description:{story:`Story: Advanced - Three-Level Nesting\r
\r
