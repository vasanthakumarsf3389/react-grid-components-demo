import{j as e}from"./index-C6j-OS9u.js";import{r as i}from"./index-CtNveh2g.js";import{C as r,a as o,m as ie,b as le,D as A,P as se,G as de,c as ue,d as ce,S as K,Q as pe,e as X,f as me,W as he,g as $,h as a,U as ge,i as fe,T as q,j as we}from"./data-Bnzj_2Sd.js";import"./index-LwkqeIug.js";const ye=[40,80,120,200],v=t=>{var D,R,E,T,G;const{enableRtl:f,enableRipple:Y,localDataCount:l,isTextWrapData:C,isDialogInsideGrid:b,isStrictMode:Z,isMultipleChildren:ee,parentContainerHeight:ne="93vh",...n}=t;((E=(R=n.columns)==null?void 0:R[((D=n.columns)==null?void 0:D.length)-1])==null?void 0:E.headerText)==="Command Actions"&&(n.columns[((T=n.columns)==null?void 0:T.length)-1].getCommandItems=()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]);const x=i.useRef(null),w=i.useRef(null),[y,te]=i.useState(!0),[S,ae]=i.useState(!1),re=i.useMemo(()=>C?ie(l):le(l,n.columns),[l,(G=n.columns)==null?void 0:G.length]),d=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>ae(!S),children:[S?"Destroy":"Render"," Data Grid"]}),l&&!C&&e.jsxs("button",{onClick:()=>te(!y),children:[y?"Uniform":"Non Uniform"," Row Height Applied"]}),S&&e.jsx(se,{dir:f?"rtl":"ltr",ripple:Y,locale:n.locale,children:e.jsx(de,{ref:x,dataSource:l?re:[],...n,columns:n.children?void 0:n.columns,aggregates:n.children?void 0:n.aggregates,getRowHeight:y?null:oe=>ye[oe.rowIndex%4],children:ee?n.children.props.children:n.children})}),e.jsx("button",{onClick:()=>{console.log(x)},children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:w,style:{height:ne},children:Z?e.jsx(i.StrictMode,{children:b?e.jsx(A,{open:!0,fullScreen:!0,target:w.current,children:d()}):d()}):b?e.jsx(A,{open:!0,fullScreen:!0,target:w.current,children:d()}):d()})};try{v.displayName="LargeDataGridTest",v.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
}`},description:`Configures loading indicator settings for the Grid component.
...
\`\`\``,name:"onDataChangeCancel",required:!1,type:{name:"(event: FormCancelEvent<unknown>) => void"}}}}}catch{}const Re={title:"Grid/VirtualGridBase",component:v,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","100","1000","10000","100000"],description:"Grid Local DataSource Count"}}},s=ce(100,!1),Se=[{columns:ue(s.length)}];s.unshift({type:we.Checkbox,width:50,allowFilter:!1});s.push({headerText:"Command Actions",width:200,getCommandItems:()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]});const u={args:{localDataCount:1e5,columns:s,aggregates:Se,editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%"}},c={args:{localDataCount:2e6,columns:s.slice(1,11),editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:2e6},height:"100%"}},p={args:{dataSource:new X({url:"https://ej2services.syncfusion.com/react/hotfix/api/UrlDataSource",adaptor:new ge}),query:new pe().addParams("dataCount","100000"),toolbar:["Search"],children:e.jsxs($,{children:[e.jsx(a,{field:"EmployeeID",visible:!1,headerText:"Employee ID",isPrimaryKey:!0,width:"130"}),e.jsx(a,{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"}),e.jsx(a,{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"}),e.jsx(a,{field:"Mail",headerText:"Mail",width:"230"}),e.jsx(a,{field:"Location",headerText:"Location",width:"140"}),e.jsx(a,{field:"Status",headerText:"Status",width:"130"})]}),selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{enableCache:!1,scrollMode:K.Virtual},height:"100%"}},m={args:{dataSource:new X({url:"https://ej2services.syncfusion.com/react/hotfix/api/GridWebAPIService",adaptor:new fe}),columns:[{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130",allowSearch:!1},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1}],selectionSettings:{mode:"Single"},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{scrollMode:K.Virtual},height:"100%"}},h={args:{dataSource:me,children:e.jsxs($,{children:[e.jsx(a,{headerText:"Employee Image",width:"180",textAlign:q.Center,field:"EmployeeID"}),e.jsx(a,{headerText:"Employee Details",width:"300",textAlign:q.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:t=>{const f=`https://npmci-react.syncfusion.com/development-react-ui/images/grid/${t.EmployeeID}.png`;return e.jsxs("tr",{className:"templateRow",children:[e.jsx("td",{className:"photo",children:e.jsx("img",{src:f,alt:t.EmployeeID.toString()})}),e.jsx("td",{className:"details",children:e.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"30%"}}),e.jsx("col",{style:{width:"10%"}})]}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"First Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:t.FirstName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Last Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:t.LastName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Title"}),e.jsx("td",{children:":"}),e.jsx("td",{children:t.Title})]})]})]})})]})}}},ve=[{field:"id"},{field:"username",width:150},{field:"age",width:80,type:"number"},{field:"bio",width:400}],g={args:{localDataCount:1e5,isTextWrapData:!0,columns:ve,height:400,textWrapSettings:{enabled:!0,wrapMode:he.Both}}};var F,k,V;u.parameters={...u.parameters,docs:{...(F=u.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
...
}`,...(W=(P=p.parameters)==null?void 0:P.docs)==null?void 0:W.source}}};var N,L,U;m.parameters={...m.parameters,docs:{...(N=m.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(U=(L=m.parameters)==null?void 0:L.docs)==null?void 0:U.source}}};var H,O,B;h.parameters={...h.parameters,docs:{...(H=h.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(B=(O=h.parameters)==null?void 0:O.docs)==null?void 0:B.source}}};var _,Q,J;g.parameters={...g.parameters,docs:{...(_=g.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    localDataCount: 100000,
    isTextWrapData: true,
    columns: muicolumns,
